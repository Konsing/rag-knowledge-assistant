...
- Tools: `research_papers` (auto ArXiv search + ingest + answer), `research` (auto web search + ingest + answer), `query_knowledge_base`, `search_chunks` (free), `ingest_arxiv`, `ingest_web_page`, `get_stats`
